...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($api_auth != $_GET['api_key']) {
        ...
        // INSERT INTO `reply` (`id`, `userid`, `questionid`, `type`, `reply`, `attachment`, `language`, `state`, `stamp`) VALUES ('1', '2', '3', 'chat', 'reply', 'attachment', 'en', '1', current_timestamp());

        $sql = "INSERT INTO `reply` (`userid`, `questionid`, `type`, `reply`, `attachment`, `language`, `state`) VALUES ( '$userId', '$questionId', '$mtype', '$reply', '$attachmentFile', '$language', '$state')";
