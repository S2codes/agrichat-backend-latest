...
<body id="body-pd">
    ...
    <section class="componentContainer">
        ...
        <div class="navigation mb-3">
            <span class="rootMenu"><a href="#">Home</a> / </span><Span class="mainMenu"><a href="#">All Farmers</a></Span>
        </div>

        <div class="row">
            <div class="col">
                <h3 style="font-weight: 600;">All Farmers</h3>
            </div>
                    ...
                    <table class="table" id="myTable">
                       <thead>
                        ...
                        <tbody>
                           ...
                           $sn = 1;
                            $q = "SELECT * FROM `users` WHERE `type` = '$usertype'  ORDER BY `users`.`id` DESC";
                            ...
                            foreach ($enquiries as $enq) {
                                ...
                                <td>'.$enq['email'].'</td>
                                <td>'.$status.'</td>
                                <td><a href="view-details?user='.$enq['id'].'&type='.$usertype.'" class="btn btn-info">View</a></td>
                                </tr>';
                                $sn = $sn +1;
                            }
